...
Config.ClothingRooms = {
    [1] = {requiredJob = 'police', isGang = false, coords = vector3(462.91, -999.12, 30.69), width = 2, length = 2, cameraLocation = vector4(462.91, -999.12, 30.69, 358.48)},
    [2] = {requiredJob = 'ambulance', isGang = false, coords = vector3(298.64, -599.28, 43.28), width = 2, length = 2, cameraLocation = vector4(298.64, -599.28, 43.28, 332.09)}, -- Right double door in Hospital Map that is on QBCore GitHub
